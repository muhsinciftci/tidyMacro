...
//' @export
// [[Rcpp::export]]
Rcpp::List fRemoveBias(const arma::mat&  beta,
                        int               c,
                        int               p,
                        const arma::cube& boot_beta) {
    // Call the C++ function
    RemoveBiasResult result = fRemoveBias_cpp(beta, c, p, boot_beta);
