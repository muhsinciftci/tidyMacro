...
FEVDIVResult fFEVDIV_cpp(arma::vec s, arma::mat S, arma::cube wold, int N, int hor,
    ...
    arma::mat fFEVDIV_result = num / denom;
...
//'   - fFEVDIV: N x (hor+1) matrix of FEVD shares (between 0 and 1)
//'
//' @details
...
//' @export
// [[Rcpp::export]]
Rcpp::List fFEVDIV(arma::vec s, arma::mat S, arma::cube wold, int N, int hor,
                   arma::mat sigma, arma::mat u, int T1, int p) {
    // Call the C++ function
    FEVDIVResult result = fFEVDIV_cpp(s, S, wold, N, hor, sigma, u, T1, p);
    ...
    return Rcpp::List::create(
        ...
        Rcpp::Named("fFEVDIV") = result.fFEVDIV
    );
}
