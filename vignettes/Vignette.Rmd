...
<img src="man/figures/tidyMacro.png" align="right" height="175"/> `tidyMacro` is an R package for fast estimation of Vector Autoregression (VAR) models via C++ (Rcpp/RcppArmadillo). Here is what it does: (will be updated as I extend functionality of the package).
