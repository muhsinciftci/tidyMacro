...
#' Accepts the full list returned by \code{fBootstrapIVMBB()} directly.
#'
#' @param result_mbb List returned by \code{fBootstrapIVMBB()}. Must contain
...
#'
#' @export
fPlotIRFIV <- function(result_mbb, varnames, shockname,
                        scale           = 1,
                        return_data     = FALSE,
                        ribbon_fill     = "#407EC9",
                        ribbon_alpha    = 0.2,
