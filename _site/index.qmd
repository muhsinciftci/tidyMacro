...
3.  **Identification via external instruments (Proxy-SVAR)** ✅
    ...
    - Weak IV Robust IRF ✅
      - **Delta method**
      - **Anderson-Rubin**
    - Replication: @kaenzig2021 — see [Proxy SVAR chapter](03_1_Kaenzig2021_ExternalIV.qmd)
...
4.  **Identification via Internal instruments** ✅
    ...
    - Replication: @kaenzig2021 — see [Internal Instruments chapter](03_3_Kaenzig2021_InternalIV.qmd)

5.  **Identification via Heteroskedasticity** following @rigobon2003 ✅

    - Impulse Response functions ✅
    - Replication: @kaenzig2021 — see [Heteroskedasticity chapter](03_2_Kaenzig2021_Hetero.qmd)
