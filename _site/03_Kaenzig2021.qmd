---
title: "Proxy SVAR (External Instruments)"
...
#| fig-cap: "IRFs — proxy IV restricted to OPEC announcement months (MBB, 68% and 90% confidence bands)"
...
## Comparison: Identification via IV vs Heteroskedasticity

```{r}
#| label: fig-irf-compare
#| fig-cap: "IRF comparison — proxy SVAR vs Heteroskedasticity"
...
Here we simply put the instrument as a first variable and achieve identification via recursive /short run restrictions. For details see @plagborg-møller2021 .
...
#| fig-cap: "IRFs to oil supply news shock — internal instruments (Cholesky, 68% and 90% confidence bands). Units: 1-SD shock to instrument."
