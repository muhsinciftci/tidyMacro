...
1.  Prefer the long-difference specification over levels, especially for persistent series.
2.  Use lag-augmented LPs with HC/White standard errors rather than plain Newey–West. Uniform validity, no bandwidth choice.
3.  Report joint bands alongside pointwise ones, and consider significance bands as a null-based complement.
4.  Report multipliers whenever the treatment-plan versus one-off distinction matters.
5.  For state dependence, verify the state is genuinely predetermined. Prefer the interaction specification over sample splitting to avoid omitting other relevant states.
6.  In staggered, absorbing-treatment panels, use LP-DiD's clean-control restriction.
7.  Never instrument nonlinear transforms of the shock through a linear first stage.
...
::: {.callout-important collapse="true" title="Further works cited"}

Named in the text above but not held in `references.bib`. Full details are in the bibliography of @jorda2025; replication code for the survey is at <https://github.com/ojorda/JEL-Code>.
...
- Cloyne, J., Jordà, Ò., and Taylor, A.M. (2023). "State-Dependent Local Projections: Understanding Impulse Response Heterogeneity." NBER WP
  30971. 
...
- Jordà, Ò. and Kozicki, S. (2011). "Estimation and Inference by the Method of Projection Minimum Distance." *International Economic Review*, 52(2), 461–487.
- Jordà, Ò., Schularick, M., and Taylor, A.M. (2015). "Betting the House." *Journal of International Economics*, 96, S2–S18.
- Jordà, Ò., Singh, S.R., and Taylor, A.M. (2024). "The Long-Run Effects of Monetary Policy." NBER WP 26666.
...
- Montiel Olea, J.L., Plagborg-Møller, M., Qian, E., and Wolf, C.K. (2024). "Double Robustness of Local Projections and Some Unpleasant VARithmetic." NBER WP 32495.
- Newey, W.K. and West, K.D. (1987). "A Simple, Positive Semi-Definite, Heteroskedasticity and Autocorrelation Consistent Covariance Matrix." *Econometrica*, 55(3), 703–708.
- Piger, J. and Stockwell, T. (2023). "Differences from Differencing: Should Local Projections with Observed Shocks be Estimated in Levels or Differences?" SSRN.
...
- Rambachan, A. and Shephard, N. (2019). "A Nonparametric Dynamic Causal Model for Macroeconometrics." Working paper.
- Ramey, V.A. (2016). "Macroeconomic Shocks and Their Propagation." In *Handbook of Macroeconomics*, vol. 2, 71–162.
- Stock, J.H. and Watson, M.W. (2018). "Identification and HAC Standard Errors for Efficient Estimation of Instrumental Variables Regressions." *Economic Journal*, 128(610), 917–948.
