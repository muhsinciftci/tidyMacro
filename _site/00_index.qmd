...
6.  **Identification via Sign, Narrative and Zero Restrictions** ✅
    ...
    - Replication 1: @uhlig2005 (sign only)
    - Replication 2: @antolindiaz2018 (sign + narrative, Volcker 1979)
    - Replication 3: @arias2019 (sign + single-instrument IV)
    - Replication 4: @cesabianchi2021 (sign + two-instrument IV, US financial shock)
